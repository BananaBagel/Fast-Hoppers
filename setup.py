...
old_java_pkg = "gay.bagel.fasthoppers"
...
if mixin_old.exists():
    ...
    replace_in_file(
        mixin_new, '"gay.bagel.fasthoppers.mixin"', f'"{new_java_pkg}.mixin"'
    )
...
print()
info("Next steps:")
print("  1. Replace src/main/resources/icon.png with your mod's icon")
